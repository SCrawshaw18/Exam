...
class CartPoleSolver():
	...
	def episode(self, params):
		...
		for i in range(10000):
			...
			action = self.choose_action(observation.flatten(), params)
			#print("acting")
